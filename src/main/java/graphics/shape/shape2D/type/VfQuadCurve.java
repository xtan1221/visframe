...
/**
 * class for a QuadCurve shape defined in visframe;
 * 
 ...
 *
 */
public class VfQuadCurve extends VfShapeTypeBase {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9136876422801573023L;
	
	//////////////////////////
	/**
	 * static factory method that returns the singleton instance of {@link VfQuadCurve}
	 */
	public static final VfQuadCurve SINGLETON;
	
	///////////////////////
	private final static SimpleName TYPE_NAME = new SimpleName("QuadCurve");
	...
	public final static GraphicsPropertyTree START_PROPERTY_TREE = 
    		new GraphicsPropertyTree(
    				...
    				new VfNotes("Defines the coordinate of the start point of the quadratic curve segment."));
	public final static GraphicsPropertyTree END_PROPERTY_TREE = 
    		new GraphicsPropertyTree(
    				...
    				new VfNotes("Defines the coordinate of the end point of the quadratic curve segment."));
	public final static GraphicsPropertyTree CONTROL_PROPERTY_TREE = 
    		new GraphicsPropertyTree(
    				new SimpleName("CONTROL"), VfBasicGraphicsPropertyNodeFactory.LAYOUT_CART_2D, 
    				new VfNotes("Defines the coordinate of the control point of the quadratic curve segment."));
    ...
    static {
        ...
        typeSpecificPropertyTreeNameMap.put(CONTROL_PROPERTY_TREE.getName(), CONTROL_PROPERTY_TREE);
        ...
        //
        SINGLETON = new VfQuadCurve(TYPE_NAME, new VfNotes(), typeSpecificPropertyTreeNameMap);
    }
	 ...
	 */
	private VfQuadCurve(SimpleName typeName, VfNotes notes, Map<SimpleName, GraphicsPropertyTree> typeSpecificPropertyTreeNameMap) {
