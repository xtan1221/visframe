...
import generic.tree.trim.VfSubTreeGenericTrimmer;
 ...
 * sub tree 
 * 
 * see {@link VfSubTreeGenericTrimmer}
 * @author tanxu
 *
 */
public final class SubTreeOperation extends VfTreeTrimmingOperationBase {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5338938883742125650L;
	
	///////////////////////////////
	public static final SimpleName TYPE_NAME = new SimpleName("SubTreeOperation");
	 ...
	 * @return
	 */
	public static Map<SimpleName, Object> buildSubTreeOperationLevelSpecificParameterNameValueObjectMap(
	 ...
	 * @param subTreeOperationLevelParameterNameObjectValueMap
	 */
	public SubTreeOperation(
//			boolean resultedFromReproducing,
			...
			Map<SimpleName, Object> subTreeOperationLevelParameterNameObjectValueMap,
		...
		for(SimpleName parameterName:levelSpecificParameterNameMap().keySet()) {
			if(!subTreeOperationLevelParameterNameObjectValueMap.containsKey(parameterName)) {//parameter not found in the input value map
				throw new IllegalArgumentException("given subTreeOperationLevelParameterNameObjectValueMap does not contain the value for parameter:"+parameterName.getStringValue());
			}
		}
		
		this.levelSpecificParameterObjectValueMap = subTreeOperationLevelParameterNameObjectValueMap;
...
//		}
	...
	/**
	 * reproduce and return a parameter name value object map of parameters at {@link SubTreeOperation} level
	 * 
	 ...
	 * @throws SQLException 
	 */
	private Map<SimpleName, Object> reproduceSubTreeOperationLevelParameterObjectValueMap(
	 ...
	 */
	@Override
	public SubTreeOperation reproduce(
			VisProjectDBContext hostVisProjctDBContext,
			VisSchemeAppliedArchiveReproducerAndInserter VSAArchiveReproducerAndInserter,
		...
		return new SubTreeOperation(
				...
				this.reproduceSubTreeOperationLevelParameterObjectValueMap(hostVisProjctDBContext, VSAArchiveReproducerAndInserter, copyIndex),
	...
	//call() method related
	/**
	 * build and perform {@link VfSubTreeGenericTrimmer}
	 */
	@Override
	protected void buildAndPerformTrimmer() {
		this.trimmer = new VfSubTreeGenericTrimmer(
